...
export const ExecutedCopyTraderPage = () => {
                ...
                <tbody>
                  <tr className="position-relative">
                    ...
                    <td className="text-center">
                      <a href="trade-configuration.html">TRXUSDT</a>
                    </td>
                    <td className="text-center">0</td>
                    <td className="text-center">1009131804</td>
                    <td className="text-center">Limit</td>
                    <td className="text-center">Sell</td>
                    {toogle === 1 && (
                      <div className="toggle">
                        <p>
                          <strong>Quantity:</strong> 0.00
                        </p>
                        <p>
                          <strong>Open Price:</strong> 0.00
                        </p>
                        <p>
                          <strong>Status:</strong> Error
                        </p>
                        <p class="mb-0">
                          <strong>Remarks:</strong> Account has insufficient
                          balance for request action
                        </p>
                      </div>
                    )}
                  </tr>
