...
export const ExecutedSignalProviderPage = () => {
            ...
            <div className="table-responsive">
              <table className="table table-striped">
                <thead className="bg-white">
                  <tr>
                    <th scope="col" className="ps-5 font small"></th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">Binance Spot</td>
                    <td className="text-center">
                  ...
                  {toogle === 1 && (
                     <div className="toggle">
                      <p><strong>Quantity:</strong> 0.00</p>
                      <p><strong>Open Price:</strong> 0.00</p>
                      <p><strong>Status:</strong> Error
                      </p><p class="mb-0"><strong>Remarks:</strong> Account has insufficient balance for request action
                      </p>
                    </div>
                    )}
                  <tr>
