...
const ActivateSignalProviderPage = () => {
            ...
            <div className="table-responsive">
              <table className="table table-striped">
                <thead className="bg-white">
                  <tr>
                    <th scope="col" className=" ttf font">
                      Full Name
                      <img src={tableArrow_icon} alt="" className="img-fluid margin" />
                    </th>
                    <th scope="col" className="ps-1 text-center font">
                      Mobile
                      <img src={tableArrow_icon} alt="" className="img-fluid margin" />
                    </th>
                ...
                <tbody>
                  <tr>
                    <td className="ttf font">
                      Arvind Kumar
                    </td>

                    <td className="text-center ps-1">8866554488</td>
                    ...
                    <td className="text-center">
                      <a href="trade-configuration.html">
                        <button className="btn btn-success btn-sm mr">Activate</button>
...
export default ActivateSignalProviderPage;
