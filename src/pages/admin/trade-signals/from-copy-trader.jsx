...
export const FromCopyTraderPage = () => {
            ...
            <div className="table-responsive">
              <table className="table table-striped">
                <thead className="bg-white">
                  <tr>
                    <th scope="col" className="ps-5 font small">
                    </th>
                    <th scope="col" className="text-center font ps-2 small">
                      Date
                ...
                <tbody>
                  <tr>
                    <td className="small" onClick={() => showToogle(1)}>
                      <img src="/img/uploads/plus.svg" alt="" className="img-fluid text-center cursor-pointer" />
                    </td>
                    
                    <td className="text-center font ps-2 small">4/4/2021</td>
                    <td className="text-center">
                      Papad Waha	
                    </td>
                    <td className="text-center">youremail@mail.com</td>
                  ...
                  {toogle === 1 && (
                      ...
                      <p><strong>Take Profit 1:</strong> 0.00</p>
                      <p><strong>Take Profit 2:</strong> 0.00</p>
                      <p><strong>Take Profit 3:</strong> 0.00
                      </p><p class="mb-0"><strong>Take Profit 4:</strong> 0.00
                      </p>
                    </div>
                    )}
                  <tr>
                    ...
                    <td className="text-center font">4/4/2021</td>
                    <td className="text-center">
                      Papad Waha	
                    </td>
                    <td className="text-center">youremail@mail.com</td>
...
// export default FromCopyTraderPage;
